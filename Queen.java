...
public class Queen extends ChessPiece{
    ...
    public boolean canMoveToPosition(ChessBoard chessBoard, int line, int column, int toLine, int toColumn) {
        ...
        if (line != toLine && column != toColumn &&
                ...
                isValidPosition(line) && isValidPosition(column) && isValidPosition(toLine) &&
                isValidPosition(toColumn) &&
        ...
        } else if (isValidPosition(line) && isValidPosition(column) && isValidPosition(toLine) && isValidPosition(toColumn)) {
